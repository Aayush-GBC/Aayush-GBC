<h1 align="center">Hey, I'm Aayush Patel 👋</h1>

<p align="center">
  <b>Cybersecurity Student · Penetration Tester · Security Researcher</b><br/>
  <i>George Brown College — Advanced Diploma in Computer Systems Technology (Cybersecurity)</i>
</p>
...
- 🎯 Goal: Securing a cybersecurity internship in security operations or offensive security
- 📍 Based in Ajax, Ontario, Canada
...
`TCP/IP` `DNS` `DHCP` `VPN/OpenVPN` `PKI` `TLS/SSL` `VLANs` `802.11 Wi-Fi`
`OWASP Top 10` `XSS` `CSRF` `SQL Injection` `Security Headers` `TLS Hardening`
...
| Shields Up Cybersecurity | AIG / Forage |
...
<p align="center">
  ...
  <img src="https://github-readme-stats.vercel.app/api/top-langs/?username=Aayush-PatelCybersecurity&layout=compact&theme=github_dark&hide_border=true" width="40%"/>
</p>
